...
class LineChartTest extends StatefulWidget {
  const LineChartTest({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  State<LineChartTest> createState() => LineChartTestState();
}

class LineChartTestState extends State<LineChartTest> {
  @override
